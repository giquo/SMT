...
public class VentanaRecorrido extends javax.swing.JFrame {
     ...
     */
    Dibujo dib;
    public VentanaRecorrido(Dibujo dib) {
        initComponents();
//        dib.setPreferredSize(new Dimension(1904, 3007));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaRecorrido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new VentanaRecorrido(new Dibujo()).setVisible(true);
            }
        });
    }
