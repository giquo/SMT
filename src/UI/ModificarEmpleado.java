...
public class ModificarEmpleado extends javax.swing.JFrame {
     ...
     */
    public ModificarEmpleado(JFrame parent, FabricaObjetos fabricaObj) {
        initComponents();
        setVisible(true);
        uiParent = parent;
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Modificar Empleado");
    ...
    private void botonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonModificarActionPerformed
        ...
        else if(!jTextField1.getText().equals("") && !jTextField2.getText().equals("") && !jTextField5.getText().equals("") && !jTextField6.getText().equals("") && !jTextField7.getText().equals("") && !jTextField8.getText().equals(""))
        {
            ...
            e.setIdEmpleado(jTextField1.getText());
            e.setNombreEmpleado(jTextField2.getText());
            e.setEstratoEmpleado(Integer.parseInt(jComboBox1.getSelectedItem()+""));
            e.setGeneroEmpleado(jComboBox2.getSelectedItem()+"");
            e.setCargo( jTextField5.getText());
            e.setDireccionEmpleado( jTextField6.getText());
            e.setSalario(Integer.parseInt(jTextField7.getText()));
            e.setTelefonoEmpleado(jTextField8.getText());
            e.setFechaNac(jDateChooserFechaNac.getDate());
