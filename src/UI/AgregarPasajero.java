...
public class AgregarPasajero extends javax.swing.JFrame {
     ...
     */
    public AgregarPasajero(JFrame parent, FabricaObjetos fabricaObj) {
        initComponents();
        setVisible(true);
        uiParent = parent;
