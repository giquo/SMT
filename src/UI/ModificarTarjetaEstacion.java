 ...
 * @author Paradise
 */
public class ModificarTarjetaEstacion extends javax.swing.JFrame {
     ...
     */
    public ModificarTarjetaEstacion(JFrame parent, FabricaObjetos fabricaObj) {
        initComponents();
        setVisible(true);
        uiParent = parent;
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Modificar Tarjeta Usada en Estacion");
    ...
    private void botonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAgregarActionPerformed
        ...
        else if(!jTextField1.getText().equals("") && !jTextField2.getText().equals(""))
        {
            ...
            ce.modificar(estacion, pin, jDateChooserFechaNac.getDate());
        }
        else
        {
