...
public class ModificarTurno extends javax.swing.JFrame {
     ...
     */
    public ModificarTurno(JFrame parent, FabricaObjetos fabricaObj) {
        initComponents();
        setVisible(true);
        uiParent = parent;
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Modificar Turno");
    ...
    private void botonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonModificarActionPerformed
        ...
        if(!jTextField1.getText().equals("") && !jTextField2.getText().equals("") && !jTextField3.getText().equals(""))
        {
            ...
            //
            Turno t = new Turno();
            Empleado e = ce.consultar(jTextField1.getText());
            Ruta r = cr.consultar(jTextField2.getText());
            Bus b = cb.consultar(jTextField3.getText());
            //
            TurnoPK tpk = new TurnoPK(jTextField3.getText(), jDateChooserFechaNac.getDate(), jComboBox1.getSelectedItem()+"");
            ...
            //ct.consultar(jTextField3.getText(), jDateChooserFechaNac.getDate(), jComboBox1.getSelectedItem()+"");
            ct.modificar(t);
        }
        else
        {
