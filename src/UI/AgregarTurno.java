...
public class AgregarTurno extends javax.swing.JFrame {
     ...
     */
    public AgregarTurno(JFrame parent, FabricaObjetos fabricaObj) {
        initComponents();
        setVisible(true);
        uiParent = parent;
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Agregar Turno");
    ...
    private void botonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAgregarActionPerformed
        ...
        if(!jTextField1.getText().equals("") && !jTextField2.getText().equals("") && !jTextField3.getText().equals(""))
        {
            ...
            String empleado = jTextField1.getText();
            String ruta = jTextField2.getText();
            String bus = jTextField3.getText();
            String jornada = jComboBox1.getSelectedItem()+"";
          
            ct.insertar(empleado, ruta, bus, jDateChooserFechaNac.getDate(), jornada);
        }
        else
        {
