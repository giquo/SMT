 ...
 * @author Paradise
 */
public class EliminarTarjetaRuta extends javax.swing.JFrame {
     ...
     */
    public EliminarTarjetaRuta(JFrame parent, FabricaObjetos fabricaObj) {
        initComponents();
        setVisible(true);
        uiParent = parent;
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Eliminar Tarjeta Usada en Ruta");
    ...
    private void botonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAgregarActionPerformed
        ...
        else if(!jTextField1.getText().equals("") && !jTextField2.getText().equals(""))
        {
            ...
            ce.eliminar(ruta, pin, jDateChooserFechaNac.getDate());
        }
        else
        {
