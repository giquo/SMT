 ...
 * @author Paradise
 */
public class AgregarVentaTarjeta extends javax.swing.JFrame {
     ...
     */
    public AgregarVentaTarjeta(JFrame parent, FabricaObjetos fabricaObj) {
        initComponents();
        setVisible(true);
        uiParent = parent;
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Agregar Tarjeta Vendida");
    ...
    private void botonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAgregarActionPerformed
        ...
        else if(!jTextField1.getText().equals("") && !jTextField2.getText().equals("") && !jTextField3.getText().equals("") && !jTextField4.getText().equals(""))
        {
            ...
            String empleado = jTextField2.getText();
            String estacion = jTextField3.getText();
            String pasajero = jTextField4.getText();

            cvt.insertar(pin, empleado, estacion, pasajero, jDateChooserFechaNac.getDate());
        }
        else
        {
