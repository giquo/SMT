...
public class AgregarEstacion extends javax.swing.JFrame {
     ...
     */
    public AgregarEstacion(JFrame parent, FabricaObjetos fabricaObj) {
        initComponents();
        setVisible(true);
        uiParent = parent;
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Agregar Estacion");
    ...
    private void botonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAgregarActionPerformed
        ...
        if(!jTextField1.getText().equals("") && !jTextField2.getText().equals("") && !jTextField6.getText().equals("") && !jTextField7.getText().equals("") )
        {
            ...
            String tipo = jComboBox3.getSelectedItem()+"";
            String direccion = jTextField6.getText();
            String empleado = jTextField7.getText();

            ces.insertar(id, nombre, tipo, direccion, empleado);
        }
        else
        {
