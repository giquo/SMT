 ...
 * @author Paradise
 */
public class AgregarTarjetaEstacion extends javax.swing.JFrame {
     ...
     */
    public AgregarTarjetaEstacion(JFrame parent, FabricaObjetos fabricaObj) {
        initComponents();
        setVisible(true);
        uiParent = parent;
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Agregar Tarjeta Usada en Estacion");
    ...
    private void botonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAgregarActionPerformed
        ...
        else if(!jTextField1.getText().equals("") && !jTextField2.getText().equals(""))
        {
            ...
            ce.insertar(pin, estacion, jDateChooserFechaNac.getDate());
        }
        else
        {
