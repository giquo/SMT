...
public class AgregarRecarga extends javax.swing.JFrame {
     ...
     */
    public AgregarRecarga(JFrame parent, FabricaObjetos fabricaObj) {
        initComponents();
        setVisible(true);
        uiParent = parent;
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Agregar Recarga");
    ...
    private void botonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAgregarActionPerformed
        ...
        else if(!jTextField1.getText().equals("") && !jTextField2.getText().equals("") && !jTextField3.getText().equals("") && !jTextField4.getText().equals("") && !jTextField5.getText().equals(""))
        {
            ...
            String idEstacion = jTextField3.getText();
            String idEmpleado = jTextField4.getText();
            int valor = Integer.parseInt(jTextField5.getText());

            cr.insertar(consecutivo, pin, idEstacion, idEmpleado, jDateChooserFechaNac.getDate(), valor);
        }
        else
        {
