...
import Controladores.ControladorVentaTarjeta;
 ...
 * @author Paradise
 */
public class ModificarVentaTarjeta extends javax.swing.JFrame {
     ...
     */
    public ModificarVentaTarjeta(JFrame parent, FabricaObjetos fabricaObj) {
        initComponents();
        setVisible(true);
        uiParent = parent;
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Modificar Tarjeta Vendida");
    ...
    private void botonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonModificarActionPerformed
        ...
        {
            ControladorVentaTarjeta cvt = new ControladorVentaTarjeta(fabrica);
            ...
            //
            Tarjeta t = ct.consultar(Integer.parseInt(jTextField1.getText()));
            Empleado e = ce.consultar(jTextField2.getText());
            Pasajero p = cp.consultar(jTextField4.getText());
            ...
            vt.setIdEstacion(es);
            vt.setIdPasajero(p);
            vt.setFecha(jDateChooserFechaNac.getDate());
            vt.setPinTarjeta(Integer.parseInt(jTextField1.getText()));
