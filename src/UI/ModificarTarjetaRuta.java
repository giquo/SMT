 ...
 * @author Paradise
 */
public class ModificarTarjetaRuta extends javax.swing.JFrame {
     ...
     */
    public ModificarTarjetaRuta(JFrame parent, FabricaObjetos fabricaObj) {
        initComponents();
        setVisible(true);
        uiParent = parent;
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Modificar Tarjeta Usada en Ruta");
    ...
    private void botonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAgregarActionPerformed
        ...
        else if(!jTextField1.getText().equals("") && !jTextField2.getText().equals(""))
        {
            ...
            ce.modificar(ruta, pin, jDateChooserFechaNac.getDate());
        }
        else
        {
