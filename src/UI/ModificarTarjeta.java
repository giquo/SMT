...
public class ModificarTarjeta extends javax.swing.JFrame {
     ...
     */
    public ModificarTarjeta(JFrame parent, FabricaObjetos fabricaObj) {
        initComponents();
        setVisible(true);
        uiParent = parent;
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Modificar Tarjeta");
    ...
    private void botonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonModificarActionPerformed
        ...
        else if(!jTextField1.getText().equals("") && !jTextField2.getText().equals("") && !jTextField3.getText().equals(""))
        {
            ...
            t.setPinTarjeta(Integer.parseInt(jTextField1.getText()));
            t.setTipoTarjeta(jComboBox2.getSelectedItem()+"");
            t.setEstadoTarjeta(jTextField2.getText());
            t.setSaldo(Integer.parseInt(jTextField3.getText()));
